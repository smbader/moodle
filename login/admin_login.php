...
$PAGE->set_url("$CFG->httpswwwroot/login/admin_login.php");
...
if (!empty($SESSION->loginerrormsg)) {
    ...
    redirect(new moodle_url($CFG->httpswwwroot . '/login/admin_login.php'));
}
...
if (isloggedin() and !isguestuser()) {
    ...
    $continue = new single_button(new moodle_url($CFG->httpswwwroot.'/login/admin_login.php', array('cancel'=>1)), get_string('cancel'), 'get');
