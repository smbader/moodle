...
$string['exportgradedate'] = 'Include date received for grades';
$string['exportgradedate_desc'] = 'If checked, a date will be included for each grade.';
...
$string['exportallusers'] = 'Include all course users in export';
$string['exportallusers_help'] = 'Include all course users in the export regardless of role(s) or enrollment status';
