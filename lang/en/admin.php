...
$string['friendlypasswords'] = 'Enable friendly passwords';
$string['friendlypasswords_help'] = 'When enabled, the first and last characters of generated passwords will only be alphanumeric. This makes copying/pasting passwords less confusing for users.';
...
$string['usewolfwaretoolbox'] = 'Use WolfWare Toolbox';
$string['usewolfwaretoolbox_desc'] = 'If enabled, WolfWare will be expected to manage the themes and course visibility options.  The course settings page will have the options removed.';
